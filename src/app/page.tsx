...
export default async function Home({ searchParams }: { searchParams: Promise<{ code?: string; solution?: string }> }) {
  ...
  return (
    <main className="mx-auto max-w-xl p-8 font-sans">
      <h1 className="text-xl font-semibold dark:text-neutral-100">리뷰이사</h1>
      <p className="mt-2 text-sm text-neutral-600 dark:text-neutral-400">
        쿠팡·네이버 스마트스토어 구매평을 고도몰 상품 후기로 한 번에 옮깁니다.
      </p>

      <div className="mt-6 rounded border border-neutral-200 bg-neutral-50 p-4 text-sm text-neutral-700 dark:border-neutral-700 dark:bg-neutral-800/60 dark:text-neutral-300">
