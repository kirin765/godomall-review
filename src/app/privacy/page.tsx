...
export default function Privacy() {
  return (
    <main className="mx-auto max-w-2xl p-8 text-sm leading-7">
      ...
      <p className="mt-1 text-xs text-neutral-500">최종 수정 2026-08-10</p>
      ...
      <p>업로드한 구매평을 이용자 본인의 고도몰 쇼핑몰 상품 후기로 옮기는 목적으로만 사용합니다.</p>

      <h2 className="mt-6 font-medium">4. 보관 및 파기</h2>
      <p>토큰은 앱 삭제 시 지체 없이 파기합니다. 업로드 파일은 처리 후 서버에 남기지 않습니다.</p>
